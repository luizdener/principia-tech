    ...
    return (
        <div className="servicos" id="Serviços">
            ...
            <div>
                ...
                <p>Para você que deseja ter mais conforto e a praticidade na sua residência, o processo de autamação residencial permite que equipamentos e iluminações sejam controlados por meio de aplicativos em seu smartphone ou até mesmo através de gestos. </p>
